...
| <a href="https://amzn.to/43ODSwh"><img src="https://m.media-amazon.com/images/I/519CP4yaFPL._AC_SX679_.jpg" width="190px" /></a> [GoControl ZigBee Hub](https://amzn.to/43ODSwh) | Used as my primary ZigBee hub for Home Assistant. Using ZigBee addon in Home Assistant |
| <a href="https://amzn.to/3ObtmJL"><img src="https://m.media-amazon.com/images/I/61iqJA-jApL._AC_SX679_.jpg" width="110px" /></a><br>[Bond IR/RF Blaster](https://amzn.to/3ObtmJL) | This saved me a lot of money and would let me integrate both of my fans into Home Assistant. The only issue is that it doesn't keep track of the status if the controllers are used but that can be solved with a Power monitor |
